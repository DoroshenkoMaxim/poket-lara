                ...
                <div class="card-body text-center">
                    ...
                    <div class="alert alert-info" role="alert">
                        ...
                        <ol class="text-start mb-0">
                            ...
                            <li>Зарегистрируйтесь по этой ссылке и проведите торговые операции</li>
                            <li>Получите постоянный доступ к системе</li>
                            <li>Авторизуйтесь через виджет Telegram для входа в сигналы</li>
                        </ol>
                    </div>
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="collapse1" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                                <div class="accordion-body">
                                    После регистрации на PocketOption и проведения торговых операций вы получаете 
                                    постоянный доступ к нашим торговым сигналам. Для входа в систему используйте 
